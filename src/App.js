...
const App = () => {
  ...
  return (
    <div className="chat-bot">
      <div className="chat-header">
        <div className="info-container">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
              <path fill="rgb(90, 10, 120)" fillOpacity="1"
      ...
      <div className="feed">
          {messages?.map((message, _index) =>
              <div key={_index}>
                  ...
                  <img src='code.svg' height={15} width={25} /> 
                  {message.author}</div>
      ...
      <textarea value={text} onChange={(e) => setText(e.target.value)} onSubmit={getResponse} onClick={getResponse}/>
